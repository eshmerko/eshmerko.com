...
class ProgramLaunch(models.Model):
    install_id = models.UUIDField(unique=True)
    app_name = models.CharField(max_length=100)
    app_version = models.CharField(max_length=20)
    system_platform = models.CharField(
        max_length=50, 
        blank=True, 
        null=True,
    ...
    class Meta:
        ...
        indexes = [
            ...
            models.Index(fields=['app_name', 'app_version']),
        ]
        ordering = ['-last_launch']

    def __str__(self):
        return f"{self.app_name} v{self.app_version} ({self.install_id})"